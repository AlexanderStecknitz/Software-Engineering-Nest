...
describe('DELETE /api/chipsProdukte', () => {
    ...
    test('Vorhandene Chipsprodukte loeschen', async () => {
        // given
    ...
    test('Chips loeschen, aber ohne Token', async () => {
        // given
        const url = `${apiPath}/${id}`;
    ...
    test('Chipsprodukte loeschen, aber mit falschem Token', async () => {
        // given
        const url = `${apiPath}/${id}`;
        const token = 'FALSCH';
        const headers = { Authorization: `Bearer ${token}` }; // eslint-disable-line @typescript-eslint/naming-convention
